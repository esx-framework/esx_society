		...
		if isBoss then
			...
			ESX.OpenContext("right", elements, function(menu,element)
				...
				elseif element.value == "withdraw_society_money" then
					local elements = {
						{unselectable = true, icon = "fas fa-wallet", title = TranslateCap('withdraw_amount'), description = TranslateCap('withdraw_amount_desc')},
						{icon = "fas fa-wallet", title = TranslateCap('amount'), input = true, inputType = "number", inputPlaceholder = TranslateCap('withdraw_society_money_amount_placeholder'), inputMin = 1, inputMax = 250000, name = "withdraw"},
				...
				elseif element.value == "deposit_money" then
					local elements = {
						{unselectable = true, icon = "fas fa-wallet", title = TranslateCap('deposit_amount'), description = TranslateCap('deposit_amount_desc')},
						{icon = "fas fa-wallet", title =  TranslateCap('amount'), input = true, inputType = "number", inputPlaceholder = TranslateCap('deposit_amount_placeholder'), inputMin = 1, inputMax = 250000, name = "deposit"},
				...
				elseif element.value == "wash_money" then
					local elements = {
						{unselectable = true, icon = "fas fa-wallet", title = TranslateCap('wash_money_amount'), description = TranslateCap('wash_money_amount_desc')},
						{icon = "fas fa-wallet", title = TranslateCap('amount'), input = true, inputType = "number", inputPlaceholder = TranslateCap('wash_money_amount_placeholder') , inputMin = 1, inputMax = 250000, name = "wash"},
...
function OpenManageGradesMenu(society, options)
	ESX.TriggerServerCallback('esx_society:getJob', function(job)
		...
		ESX.OpenContext("right", elements, function(menu,element)
			local elements = {
				{unselectable = true, icon = "fas fa-wallet", title = element.title, description = TranslateCap('change_label'), value = element.value},
				{icon = "fas fa-wallet", title = TranslateCap('label'), input = true, inputType = "text", inputPlaceholder = TranslateCap('change_label_placeholder'), name = "gradelabel"},
				{icon = "fas fa-check", title = TranslateCap('confirm'), value = "confirm"}
			}
