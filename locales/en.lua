Locales['en'] = {
  ...
  ['withdraw_amount_desc']   = 'Withdraw money from the society account',
  ['amount'] = "Amount",
  ['withdraw_society_money_amount_placeholder'] = 'Amount to withdraw..',
  ['confirm'] = 'Confirm',
  ['return'] = 'Return',
  ['deposit_amount_desc'] = 'Deposit some money into the society account',
  ['deposit_amount_placeholder'] = 'Amount to deposit..',
  ['wash_money_amount_desc'] = 'Deposit some money into the money wash',
  ['wash_money_amount_placeholder'] = 'Amount to wash..',
  ['employees_title'] = 'Employees',
  ['change_salary'] = 'Change a grade salary amount',
  ['salary_amount'] = 'Amount to change grade salary..',
  ['change_label'] = 'Change a grade label',
  ['label'] = 'Label',
